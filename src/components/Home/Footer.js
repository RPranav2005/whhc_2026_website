          ...
          <Col lg={4} md={12}>
            <div style={{ textAlign: 'left' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '15px' }}>
                <img src={logo} alt="Logo" style={{ height: '55px', transform: 'scale(1.1)', filter: 'drop-shadow(0 0 10px rgba(255, 50, 50, 0.4))' }} onClick={() => handleNavClick("/home")}  />
              </div>
              <p style={{ color: '#aaa', fontSize: '14px', lineHeight: '1.6', marginBottom: '25px', maxWidth: '350px' }}>
